...
const planetImage = document.querySelector('.planet-img-2');
const planetName = document.querySelector('.planet-name');
const pageContent = document.querySelector('.page-content');
const linkSource = document.querySelector('.link-source-2');
const planetOverview = document.querySelector('.overview-btn');
const planetStructure = document.querySelector('.structure-btn');
const planetSurface = document.querySelector('.surface-btn');

planetOverview.addEventListener('click', showPlanetOverview);
planetStructure.addEventListener('click', showPlanetStructure);
planetSurface.addEventListener('click', showPlanetSurface);

function showPlanetOverview() {
  if(planetOverview.clicked == true) {
    planetOverview.style.backgroundColor = "rgba(65, 158, 187, 0%)";
    planetOverview.style.border = "1px solid rgba(65, 158, 187, 0%)";
  }
  pageContent.textContent = planetData[0]["overview"]["content"];
  planetOverview.style.backgroundColor = "rgba(65, 158, 187, 100%)";
  planetOverview.style.border = "1px solid rgba(65, 158, 187, 100%)";
  planetImage.src = planetData[0]["images"]["planet"];
  linkSource.href = planetData[0]["overview"]["source"];
}

function showPlanetStructure() {
  pageContent.textContent = planetData[0]["structure"]["content"];
  planetStructure.style.backgroundColor = "rgba(65, 158, 187, 100%)";
  planetStructure.style.border = "1px solid rgba(65, 158, 187, 100%)";
  planetImage.src = planetData[0]["images"]["internal"];
  linkSource.href = planetData[0]["structure"]["source"];
}

function showPlanetSurface() {
  pageContent.textContent = planetData[0]["geology"]["content"];
  planetSurface.style.backgroundColor = "rgba(65, 158, 187, 100%)";
  planetSurface.style.border = "1px solid rgba(65, 158, 187, 100%)";
  planetImage.src = planetData[0]["images"]["geology"];
  linkSource.href = planetData[0]["geology"]["source"];
}