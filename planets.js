...
function showPlanetOverview() {
  ...
  planetOverview.classList.add("active");
  planetStructure.classList.remove("active");
  planetSurface.classList.remove("active");
}

function showPlanetStructure() {
  pageContent.textContent = planetData[0]["structure"]["content"];
  planetStructure.classList.add("active");
  planetOverview.classList.remove("active");
  planetSurface.classList.remove("active");
...
function showPlanetSurface() {
  ...
  planetSurface.classList.add("active");
  planetStructure.classList.remove("active");
  planetOverview.classList.remove("active");
